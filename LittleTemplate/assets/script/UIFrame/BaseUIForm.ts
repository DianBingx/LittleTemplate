...
import { GEventManager, Event_Name } from "./GEventManager";
...
export default class BaseUIForm extends cc.Component {
     ...
     * 消息机制
     */
    public SendMessage(messagType: Event_Name, parmas: any) {
        GEventManager.emit(messagType, parmas);
    }
    public ReceiveMessage(messagType: Event_Name, callback: Function, targer: any) {
