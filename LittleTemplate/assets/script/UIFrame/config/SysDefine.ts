...
export class SysDefine {
    ...
    public static SYS_MAP_NODE = "Canvas/UIROOT/Map";
    /* 节点常量 */
    ...
    /**UI常量 */
    public static SYS_LOGINUI_UI = 'prefab/UIForm/LoginUI';
    public static SYS_GALAXY_UI = 'prefab/UIForm/GalaxyUI';
    public static SYS_PROGRESSBAR_UI = 'prefab/UIForm/ProgressBarUI';
